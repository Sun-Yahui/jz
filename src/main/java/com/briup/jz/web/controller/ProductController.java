...
public class ProductController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name="price",value = "产品价格",dataType="double",required=true,paramType="query"),
            @ApiImplicitParam(name="status",value = "产品状态",required=true,dataType="string",paramType="query"),
            @ApiImplicitParam(name="productCategoryId",value = "类别id",required=true,dataType="long",paramType="query")
    })
